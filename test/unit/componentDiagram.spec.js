...
// import { buildDOM } from './support';
import ComponentDiagram from '../../src/js/components/componentDiagram';
...
describe('Component Diagram', () => {
  ...
  it('can highlight multiple nodes', () => {
    ...
    highlightedNodes.forEach((id) => expect(document.querySelector(`.highlight[data-id="${id}"`)).not.toBeNull());
